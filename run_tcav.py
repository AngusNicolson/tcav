...
def main(args):
    ...
    fig = utils_plot.plot_results(results, num_random_exp=num_random_exp, figsize=(10, 5), show=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max-examples", help="The maximum number of images per concept", type=int, default=100)
    ...
    parser.add_argument("--overwrite", help="Overwrite activations, CAVs and gradients", action="store_true")
