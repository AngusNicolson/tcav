...
from tcav.utils import (
    flatten,
    process_what_to_run_expand,
    process_what_to_run_concepts,
    process_what_to_run_randoms,
    results_to_proto,
)
...
class UtilsTest(googletest.TestCase):
    ...
    def test_process_what_to_run_randoms(self):
        self.assertEqual(
            sorted(process_what_to_run_randoms(self.pairs_to_test, "random500_1")),
    ...
    def test_results_to_proto(self):
        ...
        result_proto.cav_accuracies.positive_set_accuracy = 0.526
        result_proto.cav_accuracies.negative_set_accuracy = 0.414
        result_proto.cav_accuracies.overall_accuracy = 0.47
